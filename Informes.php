...
if ($moduleInstance || file_exists('modules/'.$MODULENAME)) {
        ...
        $field1->name = 'prptname';
        $field1->table = 'vtiger_providerreports';
        $field1->label= 'Name';
        $field1->uitype= 2;
        ...
        $field3->name = 'prptdocument';
        $field3->table = 'vtiger_providerreports';
        ...
        $field4->name = 'prptprovider';
        $field4->table = 'vtiger_providerreports';
