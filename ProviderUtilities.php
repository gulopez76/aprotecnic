...
if ($moduleInstance || file_exists('modules/'.$MODULENAME)) {
        ...
        $field1->name = 'putilsname';
        $field1->table = 'vtiger_providerutils';
        $field1->label= 'Name';
        $field1->uitype= 2;
        ...
        $field3->name = 'putilstype';
        $field3->table = 'vtiger_providerutils';
        $field3->label= 'Type';
        $field3->uitype= 33;
        ...
        $field3->setPicklistValues(Array('Electricity', 'Gas', 'Water', 'others'));
 
        $field4  = new Vtiger_Field();
        $field4->name = 'putilsprovider';
        $field4->table = 'vtiger_providerutils';
