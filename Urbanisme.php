...
if ($moduleInstance || file_exists('modules/'.$MODULENAME)) {
        ...
        $field3->name = 'urbdocument';
        $field3->table = 'vtiger_urbanisme';
        ...
        $field4->name = 'urbbuilding';
        $field4->table = 'vtiger_urbanisme';
