...
//	Function to get fieldname for uitype 28 assuming that doc has only one file upload type
	...
	static function isLinkPermitted($linkData) {
		...
		$moduleName2 = "Licensing";
		if(vtlib_isModuleActive($moduleName) && isPermitted($moduleName, 'EditView') == 'yes' || vtlib_isModuleActive($moduleName2) && isPermitted($moduleName, 'EditView') == 'yes') 		{
			return true;
		}
		return false;
	}
