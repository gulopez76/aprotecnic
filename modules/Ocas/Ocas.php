...
class Ocas extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_ocas';
	var $table_index= 'ocasid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_ocascf', 'ocasid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_ocas', 'vtiger_ocascf');
	...
	var $popup_fields = Array ('ocasname');

	// For Alphabetical search
	var $def_basicsearch_col = 'ocasname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'ocasname';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('ocasname');

	var $default_order_by = 'ocasname';
	var $default_sort_order='ASC';

        function Ocas() {
                $this->log = LoggerManager::getLogger('ocas');
                $this->log->debug("Entering Ocas() method ...");
                $this->db = PearDatabase::getInstance();
                $this->column_fields = getColumnFields('Ocas');
                $this->log->debug("Exiting Ocas method ...");
        }
