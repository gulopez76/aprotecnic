...
class Urbanisme extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_urbanisme';
	var $table_index= 'urbanismeid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_urbanismecf', 'urbanismeid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_urbanisme', 'vtiger_urbanismecf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_urbanisme' => 'urbanismeid',
		'vtiger_urbanismecf'=>'urbanismeid');
	...
	var $popup_fields = Array ('urbname');

	// For Alphabetical search
	var $def_basicsearch_col = 'urbname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'urbname';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('urbname');

	var $default_order_by = 'urbname';
	var $default_sort_order='ASC';

        function Urbanisme() {
                $this->log = LoggerManager::getLogger('urbanisme');
                $this->log->debug("Entering Urbanisme() method ...");
                $this->db = PearDatabase::getInstance();
                $this->column_fields = getColumnFields('Urbanisme');
                $this->log->debug("Exiting Urbanisme method ...");
        }
